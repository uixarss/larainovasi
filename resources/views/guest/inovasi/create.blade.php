...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        ...
        <form action="{{route('guest.store.inovasi')}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input name="nama_prg" id="prg" class="form-control" value="-">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input name="nama_keg" id="keg" class="form-control" value="-">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <textarea name="rancang_bangun" id="tujuan_inovasi" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <b class="lead">Manfaat Inovasi Daerah</b>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <textarea name="rancang_bangun" id="manfaat_inovasi" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <b class="lead">Hasil Inovasi Daerah</b>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <textarea name="rancang_bangun" id="hasil_inovasi" cols="30" rows="10"></textarea>
                        </div>
                    </div>
