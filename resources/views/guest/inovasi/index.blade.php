                ...
                <div class="header">
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-12 col-sm-6 align-right">
                            ...
                            <a href="{{route('guest.create.inovasi')}}" class="btn btn-info waves-effect">
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('guest.edit.indikator.inovasi', ['id' => $inovasi->id])}}" class="btn btn-primary"><i class="material-icons">explore</i></a>
                                        <a href="{{route('guest.edit.inovasi',['id' => $inovasi->id])}}" class="btn btn-info"><i class="material-icons">edit</i></a>
                                        <a href="{{route('guest.delete.inovasi', ['id' => $inovasi->id])}}" class="btn btn-danger" onclick="return confirm('Apakah yakin akan dihapus?')"><i class="material-icons">delete</i></a>
