...
<div class="container-fluid">
    ...
    <div class="page-title">
        <h3><i class="material-icons">people</i> Data KKN Anda</h3>
    </div>
    <!-- END PAGE TITLE -->
                ...
                <div class="header">
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-12 col-sm-6 align-right">
                            <a href="{{route('guest.create.kkn')}}" class="btn btn-info waves-effect">
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$kkn->status ?? ''}}</td>
                                    <td>
                                        <a href="{{route('guest.download.kkn', [ 'id' => $kkn->id ])}}" class="btn btn-info"><i class="tiny material-icons">file_download</i></a>
                                        <a href="{{route('guest.edit.kkn',[ 'id' => $kkn->id ])}}" class="btn btn-info"><i class="tiny material-icons">edit</i></a>
                                        <a href="{{route('guest.delete.kkn',[ 'id' => $kkn->id])}}" class="btn btn-danger"><i class="tiny material-icons">delete</i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
