...
<div class="container-fluid">
    ...
    <div class="page-title">
        <h3><i class="material-icons">book</i> Data Penelitian Anda</h3>
    </div>
    <!-- END PAGE TITLE -->
                ...
                <div class="header">
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-12 col-sm-6 align-right">
                            <a href="{{route('guest.create.penelitian')}}" class="btn btn-info waves-effect">
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('guest.download.penelitian', [ 'id' => $penelitian->id ])}}" class="btn btn-info"><i class="tiny material-icons">file_download</i></a>
                                        <a href="{{route('guest.edit.penelitian',[ 'id' => $penelitian->id ])}}" class="btn btn-info"><i class="tiny material-icons">edit</i></a>
                                        <a href="{{route('guest.delete.penelitian',[ 'id' => $penelitian->id])}}" class="btn btn-danger"><i class="tiny material-icons">delete</i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
