                ...
                <div class="header">
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-12 col-sm-6 align-right">
                            <a href="{{route('admin.create.penelitian')}}" class="btn btn-info waves-effect">
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.download.penelitian', [ 'id' => $penelitian->id ])}}" class="btn btn-info"><i class="tiny material-icons">file_download</i></a>
                                        <a href="{{route('admin.edit.penelitian',[ 'id' => $penelitian->id ])}}" class="btn btn-info"><i class="tiny material-icons">edit</i></a>
                                        <a href="{{route('admin.delete.penelitian',[ 'id' => $penelitian->id])}}" onclick="return confirm('Apakah yakin akan dihapus?')" class="btn btn-danger"><i class="tiny material-icons">delete</i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
