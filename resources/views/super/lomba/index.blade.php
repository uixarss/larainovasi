                ...
                <div class="header">
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-12 col-sm-6 align-right">
                            <a href="{{route('admin.create.lomba')}}" class="btn btn-info waves-effect">
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('detail.lomba', ['id' => $lomba->id])}}" class="btn bg-green" target="_blank"><i class="material-icons">info</i></a>
                                        <a href="{{route('admin.show.lomba',[ 'id' => $lomba->id ])}}" class="btn btn-info"><i class="tiny material-icons">remove_red_eye</i></a>
                                        <a href="{{route('admin.edit.lomba',[ 'id' => $lomba->id ])}}" class="btn bg-orange"><i class="tiny material-icons">edit</i></a>
                                        <a href="{{route('admin.delete.lomba',[ 'id' => $lomba->id])}}" onclick="return confirm('Apakah yakin akan dihapus?')" class="btn btn-danger"><i class="tiny material-icons">delete</i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
