...
@section('content')
    <div class="container-fluid posts">
        ...
        <div class="row clearfix posts">
            <form action="{{ route('admin.store.post') }}" method="post" class="form-group"
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12">
                            <div class="card" style="box-shadow: none;">
                                <div class="heading">
                                    <h5>Categories <sup style="color: red; font-size: 14px; vertical-align: -6px">*</sup>
                                    </h5>
                                </div>
                                <div class="body" id="categories-list" style="padding-top: 15px">
