...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        ...
        <form action="{{route('admin.store.inovasi')}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input name="nama_prg" id="prg" class="form-control" value="-" type="text">
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <b class="lead">Nama Kegiatan</b>
                            <input name="nama_keg" id="keg" class="form-control" value="-" type="text">
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <b class="lead">Nama Sub Kegiatan</b>
                            <select name="nama_sub_keg" id="sub_keg" onchange="getSubKeg()" class="form-control show-tick" data-size="5" data-live-search="true">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <select name="urusan_inovasi" id="urusan_inovasi" class="form-control show-tick" data-live-search="true" data-size="5">
                                ...
                                @endif
                                @endforeach
                                <option value="Fungsi Penunjang lainnya sesuai dengan ketentuan peraturan perundang-undangan">Fungsi Penunjang lainnya sesuai dengan ketentuan peraturan perundang-undangan</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
