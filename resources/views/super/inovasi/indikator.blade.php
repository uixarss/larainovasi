...
<div class="container-fluid">
    <div class="bg-white">
        <div class="breadcrumb">
            ...
            <li>
                <a href="{{route('admin.list.inovasi')}}"><i class="material-icons">people</i> Indeks Inovasi Daerah</a>
            </li>
            <li class="active">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 50px;">File Upload</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <div class="modal fade" id="tambahDataParameter{{$indikator->id}}" tabindex="-1" role="dialog" style="display: none;">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.update.indikator.inovasi',['id_inovasi' => $inovasi->id, 'id_indikator' => $indikator->id])}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-line">
                                                                            <select name="nilai" id="" class="form-control">
                                                                                ...
                                                                                <option value="{{$_indikator_nilai->nilai}}" {{($indikator->inovasi->find($inovasi->id)->pivot->bobot ?? '' == $_indikator_nilai->nilai) ? 'selected' : ''}}>{{$_indikator_nilai->uraian}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="modal fade" id="tambahDataDokumen{{$indikator->id}}" tabindex="-1" role="dialog" style="display: none;">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.upload.dokumen.indikator.inovasi',['id_inovasi' => $inovasi->id, 'id_indikator' => $indikator->id])}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn bg-green" data-toggle="modal" data-target="#lihatDokumen{{$indikator->id}}"><i class="material-icons">remove_red_eye</i></a>
                                        <div class="modal fade" id="lihatDokumen{{$indikator->id}}" tabindex="-1" role="dialog" style="display: none;">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header header">
                                                        <h4 class="modal-title">Dokumen Indikator</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach($indikator->file as $file)
                                                                        @if($file->pivot->inovasi_id == $inovasi->id)
                                                                        <tr>
                                                                            <td>{{$file->pivot->tentang}}</td>
                                                                            <td>
                                                                                {{$file->pivot->nomor_surat}}
                                                                            </td>
                                                                            <td>
                                                                                {{$file->pivot->nama_file}}
                                                                            </td>
                                                                            <td>
                                                                            <a href="{{route('admin.download.file.indikator',['id' => $file->pivot->id])}}" class="btn bg-yellow">
                                                                                <i class="material-icons">download</i>
                                                                            </a>
                                                                            <a href="{{route('admin.delete.file.indikator',['id' => $file->pivot->id])}}" class="btn bg-red">
