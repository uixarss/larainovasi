                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="card" style="box-shadow: none;">
                                        ...
                                        @foreach ($categories as $c)
                                            <div class="list-categories" style="margin-top: 10px">
                                                <a href="{{ route('admin.edit.category', $c->slug) }}"
                                                    ...
                                                    <span
                                                        style="margin-right: 8px; color: #000000;">{{ $c->name }}</span>
                                                </a>
                            ...
                            @endif
                            <a href="#" class="btn btn-block btn-grey text-white" aria-disabled="true" disabled
                                style="background:  #999999; padding: 12px; text-decoration: none; border-radius: 0px; color: #ffffff; font-size: 14px;">Create</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <div class="card" style="box-shadow: none;">
                    <div class="body">
                        ...
                        <div>
                            <form action="{{ route('admin.create.category') }}" method="post" class="form-group">
                                @csrf
                                <div class="form-line">
