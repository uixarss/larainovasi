...
<div class="container-fluid">
    <div class="bg-white">
        <div class="breadcrumb">
            ...
            <li class="active">
                <i class="material-icons">question_answer</i> FAQ Baru
            </li>
    ...
    <div class="page-title">
        <h3><i class="material-icons">question_answer</i> Tambah FAQ Baru</h3>
    </div>
    <!-- END PAGE TITLE -->
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="body">
                    ...
                    <div>
                        <form action="{{route('admin.store.faq')}}" method="post" class="form-group" enctype="multipart/form-data">
                            @csrf
                            <div class="form-line">
                            ...
                            <div class="form-line">
                                ...
                                <textarea type="text" name="answer" class="form-control" cols="20" rows="7" required></textarea>
                            </div><br>
