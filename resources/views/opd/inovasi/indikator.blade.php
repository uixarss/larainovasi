...
<div class="container-fluid">
    <div class="bg-white">
        <div class="breadcrumb">
            ...
            <li>
                <a href="{{route('opd.list.inovasi')}}"><i class="material-icons">people</i> Indeks Inovasi Daerah</a>
            </li>
            <li class="active">
                                        ...
                                        <div class="modal fade" id="tambahDataParameter{{$indikator->id}}" tabindex="-1" role="dialog" style="display: none;">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('opd.update.indikator.inovasi',['id_inovasi' => $inovasi->id, 'id_indikator' => $indikator->id])}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                        ...
                                        <div class="modal fade" id="tambahDataDokumen{{$indikator->id}}" tabindex="-1" role="dialog" style="display: none;">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('opd.upload.dokumen.indikator.inovasi',['id_inovasi' => $inovasi->id, 'id_indikator' => $indikator->id])}}" method="post" enctype="multipart/form-data">
                                                        @csrf
