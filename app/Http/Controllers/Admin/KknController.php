...
class KknController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/kkn')->with(['success' => 'Berhasil menambah KKN']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/kkn')->with(['success' => 'Berhasil diubah']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/kkn')->with(['success' => 'Berhasil menghapus KKN']);
    }
