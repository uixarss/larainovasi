...
class PenelitianController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('opd.penelitian.index',[
    ...
    {
        return view('opd.penelitian.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/opd/penelitian')->with(['success' => 'Berhasil menambah penelitian']);
    }
    ...
    public function edit($id)
    {
        ...
        return view('opd.penelitian.edit',[
            'data_penelitian' => $data_penelitian
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/opd/penelitian')->with(['success' => 'Berhasil diubah']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/opd/penelitian')->with(['success' => 'Berhasil menghapus penelitian']);
    }
