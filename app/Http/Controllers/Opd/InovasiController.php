...
class InovasiController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('opd.inovasi.create', [
            'data_opd' => $data_opd,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('opd.list.inovasi')->with(['success' => 'Berhasil menambah data inovasi!']);
    }
    ...
    public function edit($id)
    {
        ...
        $data_opd = OPD::orderBy('name', 'ASC')->get();
        if ($inovasi->created_by != Auth::id()) {
            abort(403, 'Tidak memiliki akses untuk ubah data inovasi ini');
        }
        $tahun = date('Y');
        $response_urusan = Http::withHeaders([
            'Content-Type' => 'application/json',
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($new_inovasi->created_by != Auth::id()) {
            abort(403, 'Tidak memiliki akses untuk ubah data inovasi ini');
        }
        $new_inovasi->kd_prg = $data_sub_keg[0]['kd_prg'];
        $new_inovasi->nama_prg = $data_sub_keg[0]['nama_prg'];
    ...
    public function listIndikator($id)
    {
        ...
        return view('opd.inovasi.indikator', [
            'inovasi' => $inovasi,
